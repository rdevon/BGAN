...
def main(num_epochs=200, initial_eta=2e-4):
    ...
    generator_loss = reweighted_loss(fake_out)#lasagne.objectives.binary_crossentropy(fake_out, 1).mean()
    discriminator_loss = (lasagne.objectives.binary_crossentropy(T.nnet.sigmoid(real_out), 1)
                          + lasagne.objectives.binary_crossentropy(T.nnet.sigmoid(fake_out), 0)).mean()
    ...
    for epoch in range(num_epochs):
        ...
        try:
            ...
            plt.imsave('./gen_images/mnist_samples_{}.png'.format(epoch),
